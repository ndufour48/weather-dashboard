$(document).ready(function () {
    ...
    function weatherFunction(searchTerm) {
      ...
      $.ajax({
        type: "GET",
        url: "https://api.openweathermap.org/data/2.5/weather?q=" + searchTerm + "&appid=18cb815a705ec3808c4422ccb9442a12",
        ...
        $.ajax({
          type: "GET",
          url: "https://api.openweathermap.org/data/2.5/uvi?appid=18cb815a705ec3808c4422ccb9442a12&lat=" + lat + "&lon=" + lon,
    ...
    function weatherForecast(searchTerm) {
      $.ajax({
        type: "GET",
        url: "https://api.openweathermap.org/data/2.5/forecast?q=" + searchTerm + "&appid=18cb815a705ec3808c4422ccb9442a12&units=imperial",
